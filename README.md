...
![output](./static/img/house1.png)
![output](./static/img/house2.png)

## CODE VALIDATION REPORT:

![output](./static/img/housevalid1.png)
![output](./static/img/housevalid2.png)

## RESULT:
Thus a website is designed to train the house price model and to predict the price and is hosted in the URL http://aoashwin.student.saveetha.in:8000/HouseModelTraining/  and  http://aoashwin.student.saveetha.in:8000/HouseModelPrediction/  HTML code is validated.